#!/bin/bash
#SBATCH --job-name=1_R_3RAD_popgen_DAPC
...
#SBATCH --output=1_R_3RAD_popgen_DAPC.out
#SBATCH --error=1_R_s3RAD_popgen_DAPC.err
...
R CMD BATCH 1_reseq_3RAD_popgen_DAPC.R 