#!/bin/bash
#SBATCH --job-name=2_R_samtools_popgen_LEA
...
#SBATCH --output=2_R_samtools_popgen_LEA.out
#SBATCH --error=2_R_samtools_popgen_LEA.err
...
R CMD BATCH 2_reseq_samtools_popgen_LEA.R 