...
png(file="./reseq_overlapdata_DAPC_populations.png", width = 700, 600)
...
#png(file="./varcontrib_DAPC_overlap.png", width=1000,900)
...
# Plot DAPC Clusters
png(file="./freseq_overlapdata_DAPC_rmFL097.png", width = 700,600)
...
#png(file="./varcontrib_DAPC_overlap_woFL097.png", width=1000,900)
...
write.csv(sum_stats_pops,"./reseq_overlapdata_sum_stats_pops.csv")

# Pairwise Fst per population
hgi<- genind2hierfstat(gi)

pairnei <- pairwise.neifst(hgi) # Use this data
write.csv(pairnei,file="./reseq_overlapdata_pairnei.csv")
pairwc <- pairwise.WCfst(hgi) # This data is for comparison purposes
write.csv(pairwc,file="./reseq_overlapdata_pairwc.csv")

save.image(file="./DAPC_BStats_reseq_overlap_m90_6x50x_GQ30_Q30_maf05_ma2.RData")
